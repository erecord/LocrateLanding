...
var deletionRequests = pgTable("deletion_requests", {
  id: serial("id").primaryKey(),
...
var insertDeletionRequestSchema = createInsertSchema(deletionRequests).pick({
  email: true,
  name: true,
  reason: true,
  confirmed: true
...
async function registerRoutes(app2) {
  app2.post("/api/account-deletion", async (req, res) => {
    try {
  ...
  app2.get("/api/deletion-requests", async (_req, res) => {
