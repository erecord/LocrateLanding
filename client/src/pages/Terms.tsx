          ...
          <CardContent className="p-8">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                These terms and conditions applies to the Locrate app (hereby referred to as "Application") for mobile devices that was created by Locrate (hereby referred to as "Service Provider") as a Freemium service.
              </p>
              ...
              <ul className="text-gray-600 dark:text-gray-400 mb-4 list-disc pl-6">
                ...
                <li><a href="https://sentry.io/terms/" className="text-primary hover:underline">Sentry</a></li>
              </ul>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                The Service Provider may wish to update the application at some point. The application is currently available as per the requirements for the operating system (and for any additional systems they decide to extend the availability of the application to) may change, and you will need to download the updates if you want to continue using the application. The Service Provider does not guarantee that it will always update the application so that it is relevant to you and/or compatible with the particular operating system version installed on your device. However, you agree to always accept updates to the application when offered to you. The Service Provider may also wish to cease providing the application and may terminate its use at any time without providing termination notice to you. Unless they inform you otherwise, upon any termination, (a) the rights and licences granted to you in these terms will end; (b) you must cease using the application, and (if necessary) delete it from your device.
              </p>

              <h3 className="text-xl font-semibold mt-6 mb-3">Changes to These Terms and Conditions</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at <a href="mailto:contact@locrate.app" className="text-primary hover:underline">contact@locrate.app</a>.
              </p>
            </div>
          </CardContent>
        </Card>
